...
<form class="p-5" action="" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" name="maxSize" value="1 000 000">
    <button class="" type="submit" name="submit"><img class="logoUpload" src="assets/css/up2.png"><span class="uploadBtn">UPLOAD</span></button>
    </form>
